...
import 'package:resume/models/nodes/node.dart';
import 'package:resume/models/simulation_parameters.dart';
import 'package:resume/rendering/node_hit_test.dart';
import 'package:resume/rendering/simulation_canvas.dart';
import 'package:resume/rendering/simulation_canvas_object.dart';
import 'package:resume/widgets/sidebar.dart';
...
class _CanvasScreenState extends State<CanvasScreen> with SingleTickerProviderStateMixin {
  ...
  final double maxNodeRadius = 50, minNodeRadius = 35;
  ...
  void resetSimulation() {
    ...
    _simulationParameters = SimulationParameters(
      ...
      xPositioning: size.width * 3/4,
      yPositioning: size.height * 3/4,
      alpha: 1,
